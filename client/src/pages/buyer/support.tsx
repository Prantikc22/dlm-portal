...
import { Mail, MessageSquare, LifeBuoy, Save } from 'lucide-react';
  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Contact support and manage your portal preferences</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">Your currency preference is stored on this device and applied across all amounts.</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">We’ll notify you via the bell icon when support responds.</p>
          </CardContent>
        </Card>
      </div>
    </div>
