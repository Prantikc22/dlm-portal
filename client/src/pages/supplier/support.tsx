  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Reach support and set your display preferences</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">Applied to all amounts in your portal.</p>
          </CardContent>
        </Card>
